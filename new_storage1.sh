...
echo "Grabbing down new config files (interfaces, resolv.conf)"
wget -O ~/interfaces https://raw.githubusercontent.com/sean-perryman/openstack/main/storage1_interfaces
wget -O ~/resolv.conf https://raw.githubusercontent.com/sean-perryman/openstack/main/resolv.conf

apt install -y ifupdown ifupdown-extra bridge-utils debootstrap openssh-server tcpdump vlan python3 resolvconf lm-sensors
